...
# Timer variables
GAME_DURATION = 30 # Fixed at 30 seconds
start_time = None
...
with mp_hands.Hands(min_detection_confidence=0.8, min_tracking_confidence=0.5) as hands:
    ...
    while video.isOpened() and game_active: # Loop now controlled by game_active flag
        ...
        if game_active:
            ...
            # Game Over screen (displayed when game_active becomes False)
